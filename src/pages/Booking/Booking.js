            ...
            <div className="booking-section">
                <Container>
                    ...
                    <div className="mx-auto py-5">
                        <Row xs={1} md={1} lg={1} className="d-flex align-items-center justify-content-center shadow-sm bg-light px-2 py-3">
                            <Col>
                    ...
                    <div className="mx-auto pb-5">
                        ...
                        <div className="booking-form mx-auto p-3 rounded-3 shadow-sm">
                            ...
                            <form className=" mx-auto d-flex justify-content-center align-items-center flex-column w-100" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <Button className="btn-submit border-0 fw-bold px-3 w-50 mt-3" variant="success" type="submit">Confirm</Button>
                            </form>
                        </div>
